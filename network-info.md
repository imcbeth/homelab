...
**TODO:** Document MAC Address and PoE Port values for all nodes. Entries currently marked as `-` will be updated once these details are recorded for troubleshooting and physical port mapping.
